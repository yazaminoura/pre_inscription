...
<head>
    ...
    <title>@hasSection('title')@yield('title') · @endif{{ config('etablissement.nom_court') }} {{ config('etablissement.ville') }} - Préinscription {{ date('Y') }}</title>
...
<body class="public-body">
    <header class="public-header">
        <div class="public-header-inner">
            <a href="{{ route('accueil') }}" class="public-brand">
                ...
                <span>
                    <span class="public-brand-name">{{ config('etablissement.nom') }} - {{ config('etablissement.ville') }}</span>
                    <span class="public-brand-sub">Préinscription en ligne <span class="badge-annee">{{ date('Y') }}</span></span>
                </span>
            </a>
            <nav class="public-nav">
                <a href="{{ route('accueil') }}" class="{{ request()->routeIs('accueil') ? 'active' : '' }}">Formations</a>
    ...
    <footer class="public-footer">
        © {{ date('Y') }} {{ config('etablissement.nom') }} - {{ config('etablissement.ville') }}
        · <a href="{{ config('etablissement.site') }}" target="_blank" rel="noopener">{{ parse_url(config('etablissement.site'), PHP_URL_HOST) }}</a>
    </footer>
