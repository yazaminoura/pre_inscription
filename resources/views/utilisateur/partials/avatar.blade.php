...
@if ($candidat->photo && \Illuminate\Support\Facades\Storage::disk('public')->exists($candidat->photo))
  <img src="{{ asset('storage/' . $candidat->photo) }}" class="avatar-photo" style="width: {{ $size }}px; height: {{ $size }}px;" alt="">
@else
