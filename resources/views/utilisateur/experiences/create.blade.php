        ...
        <div class="col-12">
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <h6 class="text-white text-capitalize ps-3">Ajouter une expérience</h6>
                            <a href="{{ route('experiences.index') }}" class="btn btn-sm btn-outline-light me-3">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{{ route('experiences.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                        @csrf
                        
                        <div class="row g-4">
                            <div class="col-12">
                                <h5 class="section-title">Détails de l'expérience</h5>
                            </div>
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="periode" id="periode" class="form-control @error('periode') is-invalid @enderror" value="{{ old('periode') }}" placeholder="Ex: 3 ans" required>
                                @error('periode')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @else
                            ...
                            <div class="col-md-6 form-group">
                                <label for="attestation" class="form-label">Fichier attestation (PDF, JPG, PNG)</label>
                        ...
                        <div class="text-center mt-4">
                            ...
                            <a href="{{ route('experiences.index') }}" class="btn btn-outline-secondary ms-2">
